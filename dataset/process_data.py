'''
From https://github.com/ZhangShurong/rebucket/blob/master/generate_dataset.py
...
def main():
    ...
    input_arr = ['dataset/eclipse/eclipse_platform.csv']
    output_arr = ['dataset/eclipse/df_eclipse.json']
    ...
    for index, input_csv in enumerate(input_arr):
        ...
        print
        len(generate_realbuckets(stacks))
